...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Hash-based smooth noise for organic terrain
    ...
    const smoothNoise = (x: number, y: number) => {
      ...
      for (let o = 0; o < 4; o++) {
        val += sNoise(x * freq * 0.002, y * freq * 0.002) * amp;
        totalAmp += amp; amp *= 0.45; freq *= 2.0;
      }
      return val / totalAmp;
    };
    ...
    const draw = () => {
      ...
      // Draw contour lines — zoomed in, fewer levels
